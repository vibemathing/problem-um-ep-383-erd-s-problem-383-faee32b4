...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-383-erd-s-problem-383-faee32b4-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-383"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-383-erd-s-problem-383-faee32b4-v1",
      "problem_contract_sha256": "c34fd3ef70b2f4040104d78d7ebc6606223409ea81eab81ce04baa21d53cec66",
      "problem_id": "problem:um-ep-383-erd-s-problem-383-faee32b4",
      "route_id": "route:um-ep-383-erd-s-problem-383-faee32b4-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-383-erd-s-problem-383-faee32b4-source-fidelity-01",
      "graph_id": "graph:um-ep-383-erd-s-problem-383-faee32b4-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-383-erd-s-problem-383-faee32b4-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-383-erd-s-problem-383-faee32b4-root",
          "statement": {
          ...
          "statement_sha256": "934bbac950fb39768e735a29b382e9586480d2562e3998bf71e5f6c68f14d4f7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-383-erd-s-problem-383-faee32b4-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-383-erd-s-problem-383-faee32b4-root",
      "route_id": "route:um-ep-383-erd-s-problem-383-faee32b4-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-383-5a2047092b9a",
        "url": "https://www.unsolvedmath.com/problems/EP-383"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
